    ...
    <div class='card bg-light w-100'>
        ...
        <div class="card-body">
            ...
            <ol class="rules">
                ...
                <li>
                    Les attributes rhô et thêta sont des <a href="{{asset("resources/utile/72706569_2816844148348603_1610175173321818112_n.png")}}">hallucinations</a>.
                </li>
                <li>
                    La règle de De Morgan graphique <a href="{{asset("resources/utile/47572499_2200431936877929_4541149246539169792_n.png")}}">doit être utilisée</a> en toutes circonstances.
                </li>
                <li>
                    Le CC1 de MECA301 était <a href="{{asset("resources/utile/73458986_389566058617550_3396803374283227136_n.png")}}">largement faisable</a> en une heure.
                </li>
                <li>
                    Le nombre de gens présents dans l'amphi est toujours <a href="{{asset("resources/utile/71105397_529672570938360_8217138362784415744_n.jpg")}}">strictement inférieur</a> aux nombre de signatures
            ...
            <ol class="rules">
                ...
                <li>
                    ...
                    être adressée en envoyant DONNÉES au 8 22 22 <small>(86,50€ par envoi + prix d'une Clio II finition cuir de lama)</small>.
                </li>
                <li>
                    Vous pouvez supprimer votre compte à l'aide du bouton situé sur la page <a href="{{route("compte.view")}}">"Mon compte"</a>.
                </li>
            </ol>
        </div>
    </div>
